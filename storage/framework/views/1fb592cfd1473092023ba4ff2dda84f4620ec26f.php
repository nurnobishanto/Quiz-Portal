...
} elseif ($_instance->childHasBeenRendered('LcOToGI')) {
    $componentId = $_instance->getRenderedChildComponentId('LcOToGI');
    $componentTag = $_instance->getRenderedChildComponentTagName('LcOToGI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LcOToGI');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('LcOToGI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('20B8YSq')) {
    $componentId = $_instance->getRenderedChildComponentId('20B8YSq');
    $componentTag = $_instance->getRenderedChildComponentTagName('20B8YSq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('20B8YSq');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('20B8YSq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/nurnobis/quizportal.online/vendor/filament/filament/src/../resources/views/components/topbar.blade.php ENDPATH**/ ?>