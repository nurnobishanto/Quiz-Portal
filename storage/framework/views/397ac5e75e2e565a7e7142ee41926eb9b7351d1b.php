...
} elseif ($_instance->childHasBeenRendered('l253654497-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l253654497-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l253654497-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l253654497-0');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('l253654497-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

</div>
<?php /**PATH /home/nurnobis/quizportal.online/resources/views/vendor/filament-breezy/components/auth-card.blade.php ENDPATH**/ ?>