...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
            <a href="<?php echo e(route('front')); ?>">
                ...
                <img src="<?php echo e(asset('storage/')."/".setting('site.logo')); ?>" style="max-height: 100px">
            </a>
         <?php $__env->endSlot(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                <a class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150 ml-3" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/nurnobis/quizportal.online/resources/views/auth/login.blade.php ENDPATH**/ ?>