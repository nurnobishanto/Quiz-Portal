...
<html lang="en">
<head>
    <title>Store your Post Office - <?php echo e(setting('site.title')); ?></title>
    <meta charset="utf-8">
...
<div class="container mt-5">
    <form action="<?php echo e(route('store_post_office')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-6">
                <div class="mt-2">
    ...
    <div class="m-5">
        <a href="<?php echo e(route('front')); ?>" class="btn btn-success m-2">Home</a>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary m-2">Login</a>
        <a href="<?php echo e(route('register')); ?>" class="btn btn-info m-2">Register</a>
        <a href="<?php echo e(route('portal')); ?>" class="btn btn-warning m-2">Portal</a>
    </div>
</div>
...
<?php /**PATH /home/nurnobis/quizportal.online/resources/views/add_post_office.blade.php ENDPATH**/ ?>