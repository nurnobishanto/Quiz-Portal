...
} elseif ($_instance->childHasBeenRendered('PSySxyz')) {
    $componentId = $_instance->getRenderedChildComponentId('PSySxyz');
    $componentTag = $_instance->getRenderedChildComponentTagName('PSySxyz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PSySxyz');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('PSySxyz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('P3zLXeu')) {
    $componentId = $_instance->getRenderedChildComponentId('P3zLXeu');
    $componentTag = $_instance->getRenderedChildComponentTagName('P3zLXeu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('P3zLXeu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('P3zLXeu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH E:\defence\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>